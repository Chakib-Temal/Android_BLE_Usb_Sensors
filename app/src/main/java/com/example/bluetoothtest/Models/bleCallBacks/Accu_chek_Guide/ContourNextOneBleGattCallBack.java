...
public class ContourNextOneBleGattCallBack extends BleModelCallBack {

    public final static String TAG = ContourNextOneBleGattCallBack.class.getSimpleName();
    ...
    private static final String TIME_CHARACTERISTIC = ("00002a2b-0000-1000-8000-00805f9b34fb");
    ...
    public void onDisConnected(boolean isActiveDisConnected, BleDevice device, BluetoothGatt gatt, int status) {
        ...
        MainActivity.writeTextSucces("Fin de connexion le CONTOUR Next One");
    ...
    public void onConnectSuccess(BleDevice bleDevice, BluetoothGatt gatt, int status) {
        ...
        MainActivity.writeTextSucces("Connexion ok avec CONTOUR Next One");
        ...
        public void onReadSuccess(byte[] data) {
            ...
            switch (mOperation){
                ...
                case GET_MANUFATURE_NAME:
                    ...
                    BleManager.getInstance().read(mDevice, CURRENT_TIME_SERVICE, TIME_CHARACTERISTIC, this);
                    break;
        ...
        for (BluetoothGattService service : services){
            ...
            if (service.getUuid().equals(UUID.fromString(CURRENT_TIME_SERVICE))) {
                ...
                for (BluetoothGattCharacteristic characteristic : characteristics){
                    ...
                    if (characteristic.getUuid().equals(UUID.fromString(TIME_CHARACTERISTIC))){
