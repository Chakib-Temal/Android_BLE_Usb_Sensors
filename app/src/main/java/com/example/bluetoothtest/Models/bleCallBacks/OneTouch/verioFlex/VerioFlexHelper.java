                    ...
                    if (message[5] == 0x06) {
                        ...
                        if (result.length == 4) {
                            ...
                            if (val > 100000) {
                                ...
                                OneTouchVerioFlexBleCallBack.sendAckImmediate();
                                return 1;
                            ...
                            Log.i(VerioFlexHelper.TAG, "value of Highest reccord nnumber " + VerioFlexHelper.highest_record_number);

                            final long tval = ((data.getInt(0) + TIME_OFFSET) * 1000) - ( 120 * 60 * 1000);
                            ...
                            OneTouchVerioFlexBleCallBack.measureList.add(measure.toString());
